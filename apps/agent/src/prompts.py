...
COACHME_PROMPT = (
    ...
    "- After each successful analysis, the runtime updates **`coaching_score_history`** (last two overall scores). "
    "The canvas shows a **progress strip** automatically when two clips have been analyzed — no tool call required. "
    "Use **showComparison** in chat when the athlete asks about a **specific technique** or wants a narrated comparison.\n\n"
    ...
    "7. When the user asks about improvement or progress, the canvas may already show overall **Earlier vs Latest** "
    "from `coaching_score_history` after two analyses — acknowledge it when relevant. Still call **showComparison** "
    "for technique-level or story-driven comparisons. If only one clip has been analyzed, use current scores from "
